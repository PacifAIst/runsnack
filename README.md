...
📄 [Security model and threat model](SECURITY.md) — how the boundaries work. Quick tip: power off for ~10 seconds between sessions with different people, so the GPU's memory is cleared.
